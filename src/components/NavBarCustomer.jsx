...
const NavBarCustomer = ({ onRegisterClick }) => {
        ...
        <div className='hidden lg:block' id='actions'>
          <div className='flex items-center' id='button'>
            ...
            <button
              ...
              className='w-auto h-[50px] border-[1px] text-white font-semibold border-[#283382] bg-[#283382] rounded-full px-[48px] hover:bg-transparent hover:text-[#283382]'>
              Register
            </button>
